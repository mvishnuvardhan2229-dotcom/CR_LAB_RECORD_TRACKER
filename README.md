...
https://github.com/mvishnuvardhan2229-dotcom/CR_LAB_RECORD_TRACKER/blob/main/demo3.png

Live Demo: lab-record-v-maan-1327.netlify.app

# """### after opening the list it asks for a json file to be upload which holds the data in it.A two demo files(AIML,CSE_A) json files were available in the folder i uploaded whose passwords are AI-ML@1234 and CSE_A@1234 respectively ###"""
